...
class Log(Resource):
    ...
    - type [string]: type of the pix reversal event which triggered the log creation. ex: "registered" or "paid"
    - errors [list of strings]: list of errors linked to this pix reversal event
...
def query(limit=None, after=None, before=None, types=None, reversal_ids=None, user=None):
    ...
    - reversal_ids [list of strings, default None]: list of pix reversal IDs to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkinfra.user was set before function call
    ## Return:
