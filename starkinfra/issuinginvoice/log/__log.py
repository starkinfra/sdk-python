...
class Log(Resource):
    ...
    Every time a Issuing Invoice entity is updated, a corresponding issuinginvoice.Log
    is generated for the entity. This log is never generated by the
    user, but it can be retrieved to check additional information
    on the Issuing Invoice.
    ## Attributes:
    - id [string]: unique id returned when the log is created. ex: "5656565656565656"
    - invoice [IssuingInvoice]: Issuing Invoice entity to which the log refers to.
    - errors [list of strings]: list of errors linked to this Issuing Invoice event
    - type [string]: type of the Issuing Invoice event which triggered the log creation. ex: "created" or "paid"
...
def query(ids=None, types=None, after=None, before=None, limit=None, user=None):
    ...
    - types [list of strings, default None]: filter for log event types. ex: "created" or "paid"
    - ids [list of strings, default None]: list of Issuing Invoice ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
