...
class Log(Resource):
    ...
    - type [string]: type of the pix request event which triggered the log creation. ex: "registered" or "paid"
    - errors [list of strings]: list of errors linked to this pix request event
