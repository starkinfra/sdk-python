...
class StaticBrcode(Resource):
    ...
    """
    def __init__(self, name, key_id, city, amount=None, reconciliation_id=None, url=None, id=None, uuid=None,
...
def query(limit=None, after=None, before=None, uuids=None, user=None):
...
def page(cursor=None, limit=None, after=None, before=None, uuids=None, user=None):
    """# Retrieve StaticBrcodes
