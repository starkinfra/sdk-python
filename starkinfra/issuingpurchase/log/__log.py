...
class Log(Resource):
    ...
    Every time a Issuing Purchase entity is updated, a corresponding issuingpurchase.Log
    is generated for the entity. This log is never generated by the
    user, but it can be retrieved to check additional information
    on the Issuing Purchase.
    ## Attributes:
    - id [string]: unique id returned when the log is created. ex: "5656565656565656"
    - purchase [IssuingPurchase]: Issuing Purchase entity to which the log refers to.
    - issuing_transaction_id [string]: transaction ID related to the Issuing Card.
    - errors [list of strings]: list of errors linked to this Issuing Purchase event
    - type [string]: type of the Issuing Purchase event which triggered the log creation. ex: "approved" or "denied"
...
def page(ids=None, purchase_ids=None, types=None, after=None, before=None, cursor=None, limit=None, user=None):
    ...
    - before [datetime.date or string, default None] date filter for objects created only before specified date. ex: datetime.date(2020, 3, 10)
    - types [list of strings, default None]: filter for log event types. ex: "approved" or "denied"
    - purchase_ids [list of strings, default None]: list of Issuing Purchase ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkinfra.user was set before function call
    ## Return:
