...
class Log(Resource):
    ...
    Every time a Issuing Card entity is updated, a corresponding issuingcard.Log
    is generated for the entity. This log is never generated by the
    user, but it can be retrieved to check additional information
    on the Issuing Card.
    ## Attributes:
    - id [string]: unique id returned when the log is created. ex: "5656565656565656"
    - card [IssuingCard]: Issuing Card entity to which the log refers to.
    - errors [list of strings]: list of errors linked to this Issuing Card event
    - type [string]: type of the Issuing Card event which triggered the log creation. ex: "created" or "blocked"
...
def query(ids=None, cardIds=None, types=None, after=None, before=None, limit=None, user=None):
    ...
    - card_ids [list of strings, default None]: list of Issuing Card ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkinfra.user was set before function call
    ## Return:
