...
class IndirectParticipant(Resource):
    ...
    - organization_id [string, default None]:TODO: describe
    - direct_id [string, default None]:TODO: describe
...
def delete(id, user=None):
    ...
    Delete a IndirectParticipant object linked to your workspace in the Stark Infra API
    ## Parameters (optional):
    - id [string]: IndirectParticipant object unique id. ex: "5656565656565656"
    ## Parameters (optional):
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkinfra.user was set before function call
