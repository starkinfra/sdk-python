...
def generateExampleInvoiceJson(n=1, note_nominal_amount=0, note_scheduled=date.today()): # type: (int, int, date) -> list[Invoice]
    invoices = []
...
def generateExampleInvoiceStringDateJson(n=1, note_nominal_amount=0, note_scheduled=datetime.now()): # type: (int, int, datetime) -> list[Invoice]
    invoices = []
...
def generateExampleInvoiceDatetimeJson(n=1, note_nominal_amount=0, note_scheduled=datetime.now()): # type: (int, int, datetime) -> list[Invoice]
    invoices = []
