...
class IssuingBalance(Resource):
    ...
    - id [string, default None]: unique id returned when IssuingBalance is created. ex: "5656565656565656"
    ...
    - updated [datetime.datetime, default None]: latest update datetime for the IssuingBalance. ex: datetime.datetime(2020, 3, 10, 10, 30, 0, 0)
    """
