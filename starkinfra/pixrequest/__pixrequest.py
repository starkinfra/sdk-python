...
class PixRequest(Resource):
    ...
    def __init__(self, amount,  external_id, sender_name, sender_tax_id, sender_branch_code,
                 ...
                 cash_amount=None, cashier_bank_code=None, cashier_type=None, tags=None, id=None, fee=None, status=None,
                 flow=None, method=None, sender_bank_code=None, created=None, updated=None):
