...
class CreditNote(Resource):
    """# CreditNote object
        ...
        ## Parameters (required):
        - templateId [string]: ID of the contract template which the credit note will be based on. ex: templateId="0123456789101112"
        ...
        - signers [list of contacts]: name and e-mail of signers that sign the contract. ex: signers=[{"name": "Tony Stark", "contact": "tony@starkindustries.com"}]
        Parameters (optional):
