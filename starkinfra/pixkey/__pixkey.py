...
class PixKey(Resource):
    ...
    ## Parameters (required):
    - account_created [datetime.date, datetime.datetime or string]: opening DateTime for the linked account. ex: "2022-01-01T12:00:00:00".
...
def update(id, reason, account_created=None, account_number=None, account_type=None, branch_code=None, name=None,
    ...
    ## Parameters (optional):
    - account_created [datetime.date, datetime.datetime or string, default None]: opening DateTime for the account to be linked. ex: "2022-01-01.
