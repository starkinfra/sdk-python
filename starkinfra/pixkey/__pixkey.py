...
class PixKey(Resource):
    ...
    - statistics [list of Statistic objects]: list of objects with information about the Pix key.
    - owner_statistics [list of Statistic objects]: list of objects with information about the Pix user.
    """
...
def get(id, payer_id, end_to_end_id=None, user=None, expand=None):
    ...
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkinfra.user was set before function call.
    - expand [list of strings, default None]: fields to expand information. ex: ["statistics", "ownerStatistics"]
    ## Return:
