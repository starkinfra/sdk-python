...
class Log(Resource):
    ...
    Every time a Issuing Holder entity is updated, a corresponding issuingholder.Log
    is generated for the entity. This log is never generated by the
    user, but it can be retrieved to check additional information
    on the Issuing Holder.
    ## Attributes:
    - id [string]: unique id returned when the log is created. ex: "5656565656565656"
    - holder [IssuingHolder]: Issuing Holder entity to which the log refers to.
    - errors [list of strings]: list of errors linked to this Issuing Holder event
    - type [string]: type of the Issuing Holder event which triggered the log creation. ex: "created" or "blocked"
...
def query(ids=None, holder_ids=None, types=None, after=None, before=None, limit=None, user=None):
    ...
    - types [list of strings, default None]: filter for log event types. ex: "created" or "blocked"
    - holder_ids [list of strings, default None]: list of Issuing Holder ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkinfra.user was set before function call
    ## Return:
...
def page(ids=None, holder_ids=None, types=None, after=None, before=None, cursor=None, limit=None, user=None):
