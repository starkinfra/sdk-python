...
def create(cards, expand=None, user=None):
    ...
    ## Parameters (required):
    - cards [list of IssuingCard objects]: list of IssuingCard objects to be created in the API. You can send up to 100 IssuingCard objects in a single request.
    ## Parameters (optional):
    - expand [list of strings, default None]: fields to expand information. Options: "rules", "security_code", "number", "expiration", "is_pin_defined"
